...
class Category(models.Model):
    ...
    categoryImg = models.ImageField(null=True, blank=True)
...
class SubCategory(models.Model):
    ...
    subCategoryImg = models.ImageField(null=True, blank=True)
...
class Element(models.Model):
    ...
    elementImg = models.ImageField(null=True, blank=True)
...
class Page(models.Model):
    ...
    pageFile = models.FileField(blank=True, null=True)
